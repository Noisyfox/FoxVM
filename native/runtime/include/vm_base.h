...
typedef JAVA_FLOAT      (*JavaMethodRetFloat)    (VM_PARAM_CURRENT_CONTEXT);
typedef JAVA_LONG       (*JavaMethodRetLong)     (VM_PARAM_CURRENT_CONTEXT);
...
typedef enum {
    ...
    CLASS_STATE_REGISTERED = 1,
    CLASS_STATE_RESOLVED = 2,
    CLASS_STATE_INITIALIZING = 3,
    CLASS_STATE_INITIALIZED = 4
} ClassState;
